...
create table if not exists prestamos (
	IdPrestamos int unsigned not null, #primero hacemos que sea pk y despues lo modificamos para que sea autoincrementable
...
create table if not exists movimientos (
	IdMovimientos int unsigned not null, #primero hacemos que sea pk y despues lo modificamos para que sea autoincrementable
